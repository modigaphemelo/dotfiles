...
PACKAGES="base-devel picom dunst git unzip zip ark 7zip ranger feh evince autotiling kitty code lxappearance libreoffice-still obsidian neovim polkit-gnome xdg-user-dirs ttf-liberation gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly gstreamer-vaapi x265 x264 lame ffmpegthumbs mpv audacious audacious-plugins flameshot"
