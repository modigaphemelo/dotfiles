...
PACKAGES="base-devel git unzip zip xarchiver 7zip gvfs gvfs-mtp pcmanfm feh evince autotiling alacritty code lxappearance qt5ct obsidian polkit-gnome xdg-user-dirs ttf-jetbrains-mono-nerd x265 x264 lame ffmpegthumbnailer mpv audacious audacious-plugins flameshot materia-gtk-theme pdfslicer gnome-disk-utility zsh"
