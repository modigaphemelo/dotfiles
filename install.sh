...
PACKAGES="base-devel git unzip zip xarchiver 7zip gvfs gvfs-mtp bitwarden pcmanfm feh evince autotiling alacritty code lxappearance qt5ct obsidian polkit-gnome xdg-user-dirs ttf-jetbrains-mono-nerd ffmpegthumbnailer mpv flameshot materia-gtk-theme pdfslicer gnome-disk-utility zsh valgrind gdb"
